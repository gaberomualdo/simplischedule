        ...
        <div className="pt-2 pb-3 px-3">
          ...
          <div className="flex justify-center items-center mt-6">
            <button
              ...
              type="button"
              className="transition-all inline-flex items-center px-3 py-2 border border-transparent text-sm rounded text-white bg-blue-600 hover:bg-blue-700 outline-none"
            >
            ...
            <button
              onClick={() => this.setState({ open: !this.state.open })}
              type="button"
              className="ml-2 transition-all inline-flex items-center px-3 py-2 border border-transparent text-sm rounded text-blue-800 bg-blue-200 hover:bg-blue-300 outline-none"
            >
              Close Timer
            </button>
          </div>
